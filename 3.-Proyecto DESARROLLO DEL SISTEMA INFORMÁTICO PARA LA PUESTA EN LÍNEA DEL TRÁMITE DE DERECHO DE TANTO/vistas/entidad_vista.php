...
// Determinar la consulta SQL y las variables basadas en el nombre de usuario
if ($username == $admin3) {
...
<head>
    ...
    <script>
        ...
        function setMsgEstatalContent() {
            // Obtener el contenido de la clase msg_estatal_content
            var msgEstatalContent = document.querySelector('.msg_estatal_content').innerHTML;
            // Asignar el contenido al campo de entrada oculto
        ...
        <table id="table_id" class="table">
            ...
            <?php foreach($result as $row): ?>
                <tr>
                    ...
                    <td>
                        ...
                        if (($row['estatus']) == 0) {
                            if (empty($row[$entidad])) {
                                echo "<button class='subir-button button ewindow-button option-button' 
                                             data-username='$username'
                                             data-numfolio='{$row['folio']}'
                                             data-boton=$boton>
                    ...
                    <td><?php echo btn_reportar($row['folio'], $row['ID_usuario']) ?>&nbsp;</td> 
                </tr>
            <?php endforeach; ?>
            </tbody>    
        </table>
        ...
        <div id="apopup" class="apopup">
            <div class="apopup-content">
                <form action="../php/fun_tables.php" method="post">
                    ...
                    <label style="margin-left:28vh" for="opcion">Folio:</label>
                    <input type="text" id="folio" name="folio" readonly>
                    <input type="hidden" id="id" name="id" readonly>
                    <br><br>
                    
                    <label style="margin-left:10vh" for="opcion">Reportar por:</label>
                    <select style="margin-left:2vh" id="opcion" name="opcion" required>
                    ...
                    <label for="texto" style="margin-left:10vh">Especificación de la problemática:</label>
                    <textarea style="margin-left:10vh" id="mensaje" name="mensaje" rows="4" cols="50" required></textarea><br><br>
                    
                    <input type="hidden" name="entidad" value=<?php echo $boton; ?> >
                    
                    <button type="submit" class="btn btn-outline-primary btn-lg btn-block"style="margin-left:40vh">Enviar</button>
                </form>
            </div>  
        </div>
    </div>
